...
import 'edit_service_point_model.dart';
export 'edit_service_point_model.dart';

class EditServicePointWidget extends StatefulWidget {
  const EditServicePointWidget({
    super.key,
    this.servPtDoc,
  });

  final ServicePointRecord? servPtDoc;

  @override
  State<EditServicePointWidget> createState() => _EditServicePointWidgetState();
}

class _EditServicePointWidgetState extends State<EditServicePointWidget> {
  late EditServicePointModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditServicePointModel());
