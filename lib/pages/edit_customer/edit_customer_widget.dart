                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      8.0, 0.0, 8.0, 10.0),
                                  child: TextFormField(
                                    controller: _model.searchCodeTextController,
                                    focusNode: _model.searchCodeFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                    ...
                                    keyboardType: TextInputType.number,
                                    validator: _model
                                        .searchCodeTextControllerValidator
                                        .asValidator(context),
                                    inputFormatters: [
                                      FilteringTextInputFormatter.allow(
                                          RegExp('[0-9]'))
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      8.0, 0.0, 8.0, 10.0),
                                  child: TextFormField(
                                    controller: _model.shortNameTextController,
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      8.0, 0.0, 8.0, 10.0),
                                  child: TextFormField(
                                    controller: _model.gSTnumTextController,
                                    focusNode: _model.gSTnumFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
