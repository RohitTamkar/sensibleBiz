...
import 'edit_outlet_model.dart';
export 'edit_outlet_model.dart';

class EditOutletWidget extends StatefulWidget {
  const EditOutletWidget({super.key});

  @override
  State<EditOutletWidget> createState() => _EditOutletWidgetState();
}

class _EditOutletWidgetState extends State<EditOutletWidget> {
  late EditOutletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditOutletModel());
