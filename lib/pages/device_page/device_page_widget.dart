        ...
        body: StreamBuilder<List<DeviceRecord>>(
          stream: queryDeviceRecord(
            queryBuilder: (deviceRecord) => deviceRecord.where(
              'outletId',
              isEqualTo:
                  FFAppState().outletId != '' ? FFAppState().outletId : null,
            ),
          ),
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount: deviceMList.length,
                                        itemBuilder:
                                            (context, deviceMListIndex) {
                                          final deviceMListItem =
                                              deviceMList[deviceMListIndex];
                                          return Padding(
                                            padding:
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return ListView.builder(
                                      padding: EdgeInsets.zero,
                                      scrollDirection: Axis.vertical,
                                      itemCount: deviceWList.length,
                                      itemBuilder: (context, deviceWListIndex) {
                                        final deviceWListItem =
                                            deviceWList[deviceWListIndex];
                                        return Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 10.0),
