...
import 'create_user_profile_test_model.dart';
export 'create_user_profile_test_model.dart';

class CreateUserProfileTestWidget extends StatefulWidget {
  const CreateUserProfileTestWidget({
    super.key,
    this.mobile,
  });
  ...
  @override
  State<CreateUserProfileTestWidget> createState() =>
      _CreateUserProfileTestWidgetState();
}

class _CreateUserProfileTestWidgetState
    extends State<CreateUserProfileTestWidget> {
  late CreateUserProfileTestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateUserProfileTestModel());
    ...
    _model.textFieldMobileTextController3 ??= TextEditingController();
    _model.textFieldMobileFocusNode3 ??= FocusNode();

    _model.textFieldMobileTextController4 ??= TextEditingController();
    _model.textFieldMobileFocusNode4 ??= FocusNode();
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Expanded(
                                            child: TextFormField(
                                              controller: _model
                                                  .pINTextFieldTextController1,
                                              focusNode:
                                                  _model.pINTextFieldFocusNode1,
                                              onChanged: (_) =>
                                                  EasyDebounce.debounce(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                suffixIcon: InkWell(
                                                  ...
                                                  focusNode: FocusNode(
                                                      skipTraversal: true),
                                                  child: Icon(
                                                    _model.pINTextFieldVisibility1
                                                        ? Icons
                                                            .visibility_outlined
                                                        : Icons
                                      ...
                                      onPressed: () async {
                                        ...
                                        await userProfileRecordReference.set({
                                          ...createUserProfileRecordData(
                                            ...
                                            businessId: '',
                                            outletList: '',
                                            userAccess: createUserListStruct(
                                              barcode: false,
                                              editBill: false,
                                              goodsReceived: false,
                                              productAdd: false,
                                          ...
                                          ...mapToFirestore(
                                            {
                                              'outlets':
                                                  FFAppState().nullOutlets,
                                            },
                                          ),
                                        });
                                        _model.doc = UserProfileRecord
                                            .getDocumentFromData({
                                          ...createUserProfileRecordData(
                                            name: _model
                                                .textFieldNameTextController1
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Expanded(
                                            child: TextFormField(
                                              controller: _model
                                                  .textFieldMobileTextController3,
                                              focusNode: _model
                                                  .textFieldMobileFocusNode3,
                                              onChanged: (_) =>
                                                  EasyDebounce.debounce(
                                          ...
                                          Expanded(
                                            ...
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .textFieldMobileTextController4,
                                                focusNode: _model
                                                    .textFieldMobileFocusNode4,
                                                onChanged: (_) =>
                                                    EasyDebounce.debounce(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Expanded(
                                            child: TextFormField(
                                              controller: _model
                                                  .pINTextFieldTextController2,
                                              focusNode:
                                                  _model.pINTextFieldFocusNode2,
                                              onChanged: (_) =>
                                                  EasyDebounce.debounce(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                suffixIcon: InkWell(
                                                  ...
                                                  focusNode: FocusNode(
                                                      skipTraversal: true),
                                                  child: Icon(
                                                    _model.pINTextFieldVisibility2
                                                        ? Icons
                                                            .visibility_outlined
                                                        : Icons
                                                            .visibility_off_outlined,
                                              ...
                                              keyboardType:
                                                  TextInputType.number,
                                              validator: _model
                                                  .pINTextFieldTextController2Validator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ],
                                      ...
                                      onPressed: () async {
                                        ...
                                        await userProfileRecordReference
                                          ...
                                          email: _model
                                              ...
                                              .text,
                                          quickPin: _model
                                              .pINTextFieldTextController2.text,
                                          roll: 'admin',
                                          outletId: '',
                                          loggedIn: false,
                                          active: true,
                                          ...
                                          accessToMulticounter: false,
                                          address: '',
                                          renewalDate: functions.setRenewalDate(
                                              getCurrentTimestamp),
                                        ));
                                        _model.doc1 = UserProfileRecord
                                            .getDocumentFromData(
                                                createUserProfileRecordData(
                                                  name: _model
                                                      .textFieldNameTextController2
