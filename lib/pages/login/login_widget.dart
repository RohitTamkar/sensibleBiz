...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    _model.textFieldNumberTextController1 ??= TextEditingController();
    _model.textFieldNumberFocusNode1 ??= FocusNode();

    _model.textFieldQuickTextController1 ??= TextEditingController();
    _model.textFieldQuickFocusNode1 ??= FocusNode();

    _model.textFieldNumberTextController2 ??= TextEditingController();
    _model.textFieldNumberFocusNode2 ??= FocusNode();
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 25.0),
                                child: Text(
                                  'Manage Billing, Inventory & Franchise all at one Place',
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                child: TextFormField(
                                                  controller: _model
                                                      .textFieldNumberTextController1,
                                                  focusNode: _model
                                                      .textFieldNumberFocusNode1,
                                                  autofocus: true,
                                                  obscureText: false,
                                                  decoration: InputDecoration(
                                                    isDense: true,
                                                    hintText: 'Phone Sign In',
                                                  ...
                                                  decoration: InputDecoration(
                                                    ...
                                                    suffixIcon: InkWell(
                                                      ...
                                                      focusNode: FocusNode(
                                                          skipTraversal: true),
                                                      child: Icon(
                                                        _model.textFieldQuickVisibility1
                                                            ? Icons
                                                                .visibility_outlined
                                                            : Icons
                                      ...
                                      if (_model.res!) {
                                        ...
                                        _model.res11 = await actions.login(
                                          _model.textFieldNumberTextController1
                                              .text,
                                          _model.textFieldQuickTextController1
                                              .text,
                                        );
                                        _shouldSetState = true;
                                        if (_model.res11!) {
                                                          ...
                                                          children: [
                                                            ...
                                                            Expanded(
                                                              child:
                                                                  TextFormField(
                                                                controller: _model
                                                                    .textFieldNumberTextController2,
                                                                focusNode: _model
                                                                    .textFieldNumberFocusNode2,
                                                                autofocus: true,
                                                                obscureText:
                                                                    false,
                                                                decoration:
                                                          ...
                                                          children: [
                                                            Expanded(
                                                              child:
                                                                  TextFormField(
                                                                controller: _model
                                                                    .textFieldQuickTextController2,
                                                                focusNode: _model
                                                                    .textFieldQuickFocusNode2,
                                                                autofocus: true,
                                                                obscureText: !_model
                                                                  ...
                                                                  suffixIcon:
                                                                    ...
                                                                    focusNode: FocusNode(
                                                                        skipTraversal:
                                                                            true),
                                                                    child: Icon(
                                                                      _model.textFieldQuickVisibility2
                                                                          ? Icons
                                                                              .visibility_outlined
                                                                          : Icons
                                                                              .visibility_off_outlined,
