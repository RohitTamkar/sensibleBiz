...
export 'stock_request_model.dart';

class StockRequestWidget extends StatefulWidget {
  const StockRequestWidget({
    super.key,
  ...
  @override
  State<StockRequestWidget> createState() => _StockRequestWidgetState();
}

class _StockRequestWidgetState extends State<StockRequestWidget> {
  late StockRequestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StockRequestModel());
