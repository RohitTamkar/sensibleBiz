...
import 'gstwiseproductsale_report_model.dart';
export 'gstwiseproductsale_report_model.dart';

class GstwiseproductsaleReportWidget extends StatefulWidget {
  const GstwiseproductsaleReportWidget({
    super.key,
    this.prdTestList,
    this.json,
  });
  ...
  @override
  State<GstwiseproductsaleReportWidget> createState() =>
      _GstwiseproductsaleReportWidgetState();
}

class _GstwiseproductsaleReportWidgetState
    extends State<GstwiseproductsaleReportWidget>
    with TickerProviderStateMixin {
  late GstwiseproductsaleReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GstwiseproductsaleReportModel());
