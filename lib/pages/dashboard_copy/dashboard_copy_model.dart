...
class DashboardCopyModel extends FlutterFlowModel<DashboardCopyWidget> {
  ...
  // Stores action output result for [Custom Action - getShiftDetails] action in DashboardCopy widget.
  List<dynamic>? loadShiftData;
  // Stores action output result for [Custom Action - getShiftSummary] action in DashboardCopy widget.
  dynamic? loadShiftSummary;
  // Stores action output result for [Custom Action - diffBetweenDates] action in DashboardCopy widget.
  String? loadTime;
