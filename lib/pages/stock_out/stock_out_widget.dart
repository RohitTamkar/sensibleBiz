...
import '/components/requested_stock_out_widget.dart';
...
import 'stock_out_model.dart';
export 'stock_out_model.dart';

class StockOutWidget extends StatefulWidget {
  const StockOutWidget({
    super.key,
...
class _StockOutWidgetState extends State<StockOutWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StockOutModel());
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                child:
                                                                    RequestedStockOutWidget(
                                                                  key: Key(
                                                                      'Key4yd_${listIndex}_of_${list.length}'),
                                                                  parameter1:
                                                                      getJsonField(
                                                                    listItem,
                                                                    r'''$.reqStock''',
