...
import '/components/deacivate_sheet/deacivate_sheet_widget.dart';
...
import 'delete_user_profile_model.dart';
export 'delete_user_profile_model.dart';
...
class DeleteUserProfileWidget extends StatefulWidget {
  ...
  @override
  State<DeleteUserProfileWidget> createState() =>
      _DeleteUserProfileWidgetState();
}

class _DeleteUserProfileWidgetState extends State<DeleteUserProfileWidget> {
  late DeleteUserProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteUserProfileModel());
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            StreamBuilder<
                                              ...
                                              stream: queryUserDeletionRecord(
                                                queryBuilder:
                                                    (userDeletionRecord) =>
                                                        userDeletionRecord
                                                            .where(
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                final containerUserDeletionRecord =
                                                    containerUserDeletionRecordList
                                                            .isNotEmpty
                                                        ? containerUserDeletionRecordList
                                                            .first
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            ' Requested To Delete User Account  ',
                                                  ...
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      var _shouldSetState =
                                                          false;
                                                      _model.delDoc =
                                                          await queryUserDeletionRecordOnce(
                                                        queryBuilder:
                                                            (userDeletionRecord) =>
                                                                userDeletionRecord
                                                                    .where(
