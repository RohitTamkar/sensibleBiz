...
class _AddCustomerWidgetState extends State<AddCustomerWidget> {
  ...
  void initState() {
    ...
    _model.alternateNumberTextController ??= TextEditingController();
    _model.alternateNumberFocusNode ??= FocusNode();
    ...
    _model.creditLimitTextController ??= TextEditingController();
    _model.creditLimitFocusNode ??= FocusNode();

    _model.dayLimitTextController ??= TextEditingController();
    _model.dayLimitFocusNode ??= FocusNode();
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await customerRecordReference
                                    ...
                                    altContact: _model
                                        .alternateNumberTextController.text,
                                    birthdayDate: _model.birthday,
                                    anniversaryDate: _model.anniversary,
                                    allowedCredit: _model.checkboxValue,
                                    balance: int.tryParse(
                                        _model.oldBalenceTextController.text),
                                    creditLimit: int.tryParse(
                                        _model.creditLimitTextController.text),
                                    dayLimit: int.tryParse(
                                        _model.dayLimitTextController.text),
                                    gstNo: _model.gSTNumberTextController.text,
                                  ));
                                  _model.createdCust =
                                      CustomerRecord.getDocumentFromData(
                                          createCustomerRecordData(
                                            ...
                                            altContact: _model
                                                .alternateNumberTextController
                                                .text,
                                            birthdayDate: _model.birthday,
                                            anniversaryDate: _model.anniversary,
                                            allowedCredit: _model.checkboxValue,
                                            balance: int.tryParse(_model
                                                .oldBalenceTextController.text),
                                            creditLimit: int.tryParse(_model
                                                .creditLimitTextController
                                                .text),
                                            dayLimit: int.tryParse(_model
                                  ...
                                  await _model.createdCust!.reference
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.alternateNumberTextController,
                                    focusNode: _model.alternateNumberFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.creditLimitTextController,
                                    focusNode: _model.creditLimitFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                    ...
                                    validator: _model
                                        .creditLimitTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      8.0, 0.0, 8.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.dayLimitTextController,
                                    focusNode: _model.dayLimitFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Day Limit',
                                    ...
                                    validator: _model
                                        .dayLimitTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      8.0, 0.0, 8.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.oldBalenceTextController,
                                    focusNode: _model.oldBalenceFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Old Balence',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily:
                                    ...
                                    validator: _model
                                        .oldBalenceTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ],
