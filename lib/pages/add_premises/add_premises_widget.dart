...
import 'add_premises_model.dart';
export 'add_premises_model.dart';

class AddPremisesWidget extends StatefulWidget {
  const AddPremisesWidget({
    super.key,
    int? codeLen,
    this.proRef,
  ...
  @override
  State<AddPremisesWidget> createState() => _AddPremisesWidgetState();
}

class _AddPremisesWidgetState extends State<AddPremisesWidget> {
  late AddPremisesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddPremisesModel());
