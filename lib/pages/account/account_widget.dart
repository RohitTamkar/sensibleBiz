...
class _AccountWidgetState extends State<AccountWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UserDeletionRecord>>(
      stream: queryUserDeletionRecord(
        queryBuilder: (userDeletionRecord) => userDeletionRecord.where(
          'userId',
                                        ...
                                        if (accountUserDeletionRecord
                                          ...
                                          Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                'Account deactivation is being  processed within 15 days!!',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelSmall
                                                        .override(
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    if (accountUserDeletionRecord != null) {
                                      if (accountUserDeletionRecord!.isDelete) {
                                        await showDialog(
                                          context: context,
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (confirmDialogResponse) {
                                    await actions.clearSessionStorage();
