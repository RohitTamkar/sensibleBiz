...
import 'add_outlet_model.dart';
export 'add_outlet_model.dart';

class AddOutletWidget extends StatefulWidget {
  const AddOutletWidget({
    super.key,
    this.qr,
  });
  ...
  @override
  State<AddOutletWidget> createState() => _AddOutletWidgetState();
}

class _AddOutletWidgetState extends State<AddOutletWidget> {
  late AddOutletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddOutletModel());
                                    ...
                                    return InkWell(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          _model.outletDoc =
                                              OutletRecord.getDocumentFromData(
                                          ...
                                          await _model.outletDoc!.reference
                                            ...
                                            id: _model.outletDoc?.reference.id,
                                          ));

                                          await buttonDeviceRecord!.reference
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return WebViewAware(
                                                child: AlertDialog(
                                                  title: Text('Outlet Created'),
                                                  content: Text(
                                                      '${_model.textController1.text} has been created '),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
