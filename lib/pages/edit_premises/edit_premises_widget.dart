...
import 'edit_premises_model.dart';
export 'edit_premises_model.dart';

class EditPremisesWidget extends StatefulWidget {
  const EditPremisesWidget({
    super.key,
    this.premDoc,
  });

  final PremisesRecord? premDoc;

  @override
  State<EditPremisesWidget> createState() => _EditPremisesWidgetState();
}

class _EditPremisesWidgetState extends State<EditPremisesWidget> {
  late EditPremisesModel _model;
