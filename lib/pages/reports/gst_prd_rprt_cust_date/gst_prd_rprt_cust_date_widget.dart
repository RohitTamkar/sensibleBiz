...
import '/components/g_s_tsale_summary_report/g_s_tsale_summary_report_widget.dart';
...
import 'gst_prd_rprt_cust_date_model.dart';
export 'gst_prd_rprt_cust_date_model.dart';

class GstPrdRprtCustDateWidget extends StatefulWidget {
  const GstPrdRprtCustDateWidget({
    super.key,
    this.prdTestList,
    this.json,
    this.start,
  ...
  @override
  State<GstPrdRprtCustDateWidget> createState() =>
      _GstPrdRprtCustDateWidgetState();
}

class _GstPrdRprtCustDateWidgetState extends State<GstPrdRprtCustDateWidget>
    with TickerProviderStateMixin {
  late GstPrdRprtCustDateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GstPrdRprtCustDateModel());
