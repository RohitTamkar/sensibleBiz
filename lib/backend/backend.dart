...
import 'schema/multipliers_record.dart';
import 'schema/expense_header_record.dart';
import 'schema/upi_configuration_qrcode_record.dart';
import 'dart:async';
...
export 'schema/multipliers_record.dart';
export 'schema/expense_header_record.dart';
export 'schema/upi_configuration_qrcode_record.dart';
...
/// Functions to query MultipliersRecords (as a Stream and as a Future).
Future<int> queryMultipliersRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MultipliersRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MultipliersRecord>> queryMultipliersRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      MultipliersRecord.collection(parent),
      MultipliersRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MultipliersRecord>> queryMultipliersRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<MultipliersRecord>> queryMultipliersRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, MultipliersRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      MultipliersRecord.collection(parent),
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<MultipliersRecord> data) {
          data.forEach((item) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query UpiConfigurationQrcodeRecords (as a Stream and as a Future).
Future<int> queryUpiConfigurationQrcodeRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UpiConfigurationQrcodeRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UpiConfigurationQrcodeRecord>> queryUpiConfigurationQrcodeRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<List<UpiConfigurationQrcodeRecord>>
    queryUpiConfigurationQrcodeRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<UpiConfigurationQrcodeRecord>>
    queryUpiConfigurationQrcodeRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, UpiConfigurationQrcodeRecord>
      controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
        queryCollectionPage(
          ...
          if (isStream) {
            final streamSubscription = (page.dataStream)
                ?.listen((List<UpiConfigurationQrcodeRecord> data) {
              data.forEach((item) {
                final itemIndexes = controller.itemList!
                    .asMap()
                    .map((k, v) => MapEntry(v.reference.id, k));
