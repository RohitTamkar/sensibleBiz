...
import 'stock_report_model.dart';
export 'stock_report_model.dart';

class StockReportWidget extends StatefulWidget {
  const StockReportWidget({super.key});

  @override
  State<StockReportWidget> createState() => _StockReportWidgetState();
}

class _StockReportWidgetState extends State<StockReportWidget> {
  late StockReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StockReportModel());
