...
import 'add_service_point_model.dart';
export 'add_service_point_model.dart';

class AddServicePointWidget extends StatefulWidget {
  const AddServicePointWidget({super.key});

  @override
  State<AddServicePointWidget> createState() => _AddServicePointWidgetState();
}

class _AddServicePointWidgetState extends State<AddServicePointWidget> {
  late AddServicePointModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddServicePointModel());
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_model.radioButton2Value == 'Ethernet')
                              Container(
                                ...
                                child: Visibility(
                                  visible:
                                      _model.radioButton2Value == 'Ethernet',
                                  child: Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      Row(
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 10.0, 0.0, 0.0),
                                        child: Text(
                                          'Here is some Port No e.g.(6001, 9100, 9001)',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily:
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Service Point Header',
                                  labelStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Service Point Sub Header',
                                  labelStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Service Point Footer',
                                  labelStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await servicePointRecordReference
                                        ...
                                        header: _model.textController4.text,
                                        name: _model.textController1.text,
                                        paperSize:
                                            _model.radioButton1Value == '2 Inch'
                                                ? 2
                                                : 3,
                                        port: int.tryParse(_model
                                            .textField3TextController.text),
                                        printerIpAddress: _model
                                            .textField2TextController.text,
                                        printerType: () {
                                          if (_model.radioButton1Value ==
                                              'Serial') {
                                            return 0;
                                          } else if (_model.radioButton1Value ==
                                              'Ethernet') {
                                            return 1;
                                          } else {
                                            return 2;
                                        ...
                                        subHeader: _model
                                            .textField2TextController.text,
                                        usbPath: _model.textField3TextController
                                                        .text !=
                                                    null &&
                                                _model.textField3TextController
                                                        .text !=
                                      ...
                                      _model.created = ServicePointRecord
                                          .getDocumentFromData(
