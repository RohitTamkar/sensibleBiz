...
import 'requested_stock_out_model.dart';
export 'requested_stock_out_model.dart';

class RequestedStockOutWidget extends StatefulWidget {
  const RequestedStockOutWidget({
    super.key,
    this.parameter1,
    this.parameter2,
  });
  ...
  @override
  State<RequestedStockOutWidget> createState() =>
      _RequestedStockOutWidgetState();
}

class _RequestedStockOutWidgetState extends State<RequestedStockOutWidget> {
  late RequestedStockOutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestedStockOutModel());
      ...
      fieldViewBuilder: (
        ...
        return TextFormField(
          ...
          onChanged: (_) => EasyDebounce.debounce(
            ...
            () async {
              _model.result1 = await actions.decrementStockNew1(
                widget!.parameter2!,
                valueOrDefault<int>(
                  FFAppState().selBill,
                  0,
              ...
              FFAppState().productCart =
                  _model.result1!.toList().cast<dynamic>();
              safeSetState(() {});
