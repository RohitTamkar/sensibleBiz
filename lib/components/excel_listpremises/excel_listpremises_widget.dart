...
import 'excel_listpremises_model.dart';
export 'excel_listpremises_model.dart';

class ExcelListpremisesWidget extends StatefulWidget {
  const ExcelListpremisesWidget({
    super.key,
    this.prdname,
    this.regionalName,
    this.defaultPrice,
  ...
  @override
  State<ExcelListpremisesWidget> createState() =>
      _ExcelListpremisesWidgetState();
}

class _ExcelListpremisesWidgetState extends State<ExcelListpremisesWidget> {
  late ExcelListpremisesModel _model;
