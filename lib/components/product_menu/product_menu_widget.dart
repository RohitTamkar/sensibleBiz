...
import 'product_menu_model.dart';
export 'product_menu_model.dart';

class ProductMenuWidget extends StatefulWidget {
  const ProductMenuWidget({super.key});

  @override
  State<ProductMenuWidget> createState() => _ProductMenuWidgetState();
}

class _ProductMenuWidgetState extends State<ProductMenuWidget> {
  late ProductMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductMenuModel());
                ...
                child: Row(
                  ...
                  children: [
                    Align(
                      ...
                      child: Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(5.0, 15.0, 0.0, 5.0),
                        child: Text(
                          'Tax',
                          style: FlutterFlowTheme.of(context)
                              .titleSmall
