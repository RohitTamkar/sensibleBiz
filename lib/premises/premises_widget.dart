...
import 'premises_model.dart';
export 'premises_model.dart';

class PremisesWidget extends StatefulWidget {
  const PremisesWidget({
    super.key,
    this.outletId,
    this.outletDetails,
  });
  ...
  @override
  State<PremisesWidget> createState() => _PremisesWidgetState();
}

class _PremisesWidgetState extends State<PremisesWidget> {
  late PremisesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PremisesModel());
                    ...
                    if (confirmDialogResponse) {
                      ...
                      await showDialog(
                        ...
                        builder: (alertDialogContext) {
                          return WebViewAware(
                            child: AlertDialog(
                              title: Text('All premises Deleted successfully'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
